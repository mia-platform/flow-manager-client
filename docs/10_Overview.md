...
The library uses [KafkaJS](https://kafka.js.org/) to actually connect to
...
// define which action should be executed when the specified command is received
client.onCommand(
  'COMMAND',
...
**Note:** users of [`custom-plugin-lib`](https://docs.mia-platform.eu/docs/development_suite/api-console/api-design/plugin_baas_4)
