...
const DEFAULT_MAX_WAITING_TIME_MS = 1000
  ...
  properties: {
    kafkaConf: {
      ...
      properties: {
        ...
        maxWaitTimeInMs: { type: 'integer', default: DEFAULT_MAX_WAITING_TIME_MS, description: 'The maximum amount of time in milliseconds the server will block before answering the fetch request if there isn’t sufficient data to immediately satisfy the requirement given by minBytes' },
      },
    },
    components: {
      type: 'object',
